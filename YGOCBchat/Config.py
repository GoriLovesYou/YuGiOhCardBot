...
Subreddits are missing from the chat bot config because it isn't posting to any sub.
...
The closing formula is missing from the chat bot config so that it doesn't sign every instant message like a grandmother.
"""
